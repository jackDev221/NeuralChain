...
import (
	...
	"github.com/lvbin2012/NeuralChain/common/fdlimit"
	...
	tdmintBackend "github.com/lvbin2012/NeuralChain/consensus/tendermint/backend"
	...
	"github.com/lvbin2012/NeuralChain/metrics/influxdb"
...
var (
	...
	NetworkIdFlag = cli.Uint64Flag{
		...
		Value: neut.DefaultConfig.NetworkId,
	}
	...
	defaultSyncMode = neut.DefaultConfig.SyncMode
	...
	LightPeersFlag = cli.IntFlag{
		...
		Value: neut.DefaultConfig.LightPeers,
	}
	...
	EthashCachesInMemoryFlag = cli.IntFlag{
		...
		Value: neut.DefaultConfig.Ethash.CachesInMem,
	}
	EthashCachesOnDiskFlag = cli.IntFlag{
		Name:  "ethash.cachesondisk",
		Usage: "Number of recent ethash caches to keep on disk (16MB each)",
		Value: neut.DefaultConfig.Ethash.CachesOnDisk,
	}
	EthashDatasetDirFlag = DirectoryFlag{
		Name:  "ethash.dagdir",
		Usage: "Directory to store the ethash mining DAGs (default = inside home folder)",
		Value: DirectoryString{neut.DefaultConfig.Ethash.DatasetDir},
	}
	EthashDatasetsInMemoryFlag = cli.IntFlag{
		Name:  "ethash.dagsinmem",
		Usage: "Number of recent ethash mining DAGs to keep in memory (1+GB each)",
		Value: neut.DefaultConfig.Ethash.DatasetsInMem,
	}
	EthashDatasetsOnDiskFlag = cli.IntFlag{
		Name:  "ethash.dagsondisk",
		Usage: "Number of recent ethash mining DAGs to keep on disk (1+GB each)",
		Value: neut.DefaultConfig.Ethash.DatasetsOnDisk,
	}
	...
	TxPoolPriceLimitFlag = cli.Uint64Flag{
		...
		Value: neut.DefaultConfig.TxPool.PriceLimit,
	}
	TxPoolPriceBumpFlag = cli.Uint64Flag{
		Name:  "txpool.pricebump",
		Usage: "Price bump percentage to replace an already existing transaction",
		Value: neut.DefaultConfig.TxPool.PriceBump,
	}
	TxPoolAccountSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.accountslots",
		Usage: "Minimum number of executable transaction slots guaranteed per account",
		Value: neut.DefaultConfig.TxPool.AccountSlots,
	}
	TxPoolGlobalSlotsFlag = cli.Uint64Flag{
		Name:  "txpool.globalslots",
		Usage: "Maximum number of executable transaction slots for all accounts",
		Value: neut.DefaultConfig.TxPool.GlobalSlots,
	}
	TxPoolAccountQueueFlag = cli.Uint64Flag{
		Name:  "txpool.accountqueue",
		Usage: "Maximum number of non-executable transaction slots permitted per account",
		Value: neut.DefaultConfig.TxPool.AccountQueue,
	}
	TxPoolGlobalQueueFlag = cli.Uint64Flag{
		Name:  "txpool.globalqueue",
		Usage: "Maximum number of non-executable transaction slots for all accounts",
		Value: neut.DefaultConfig.TxPool.GlobalQueue,
	}
	TxPoolLifetimeFlag = cli.DurationFlag{
		Name:  "txpool.lifetime",
		Usage: "Maximum amount of time non-executable transaction are queued",
		Value: neut.DefaultConfig.TxPool.Lifetime,
	}
	...
	MinerGasTargetFlag = cli.Uint64Flag{
		...
		Value: neut.DefaultConfig.Miner.GasFloor,
	}
	...
	MinerGasLimitFlag = cli.Uint64Flag{
		...
		Value: neut.DefaultConfig.Miner.GasCeil,
	}
	...
	MinerRecommitIntervalFlag = cli.DurationFlag{
		...
		Value: neut.DefaultConfig.Miner.Recommit,
	}
	...
	GpoBlocksFlag = cli.IntFlag{
		...
		Value: neut.DefaultConfig.GPO.Blocks,
	}
	GpoPercentileFlag = cli.IntFlag{
		Name:  "gpopercentile",
		Usage: "Suggested gas price is the given percentile of a set of recent transaction gas prices",
		Value: neut.DefaultConfig.GPO.Percentile,
	}
	...
	TendermintBlockPeriodFlag = cli.Uint64Flag{
		...
		Value: neut.DefaultConfig.Tendermint.BlockPeriod,
	}
	...
	TendermintTimeoutProposeDeltaFlag = cli.DurationFlag{
		...
		Value: neut.DefaultConfig.Tendermint.TimeoutProposeDelta,
	}
	TendermintTimeoutPrevoteFlag = cli.DurationFlag{
		...
		Value: neut.DefaultConfig.Tendermint.TimeoutPrevote,
	}
	TendermintTimeoutPrevoteDeltaFlag = cli.DurationFlag{
		...
		Value: neut.DefaultConfig.Tendermint.TimeoutPrevoteDelta,
	}
	TendermintTimeoutPrecommitFlag = cli.DurationFlag{
		...
		Value: neut.DefaultConfig.Tendermint.TimeoutPrecommit,
	}
	TendermintTimeoutPrecommitDeltaFlag = cli.DurationFlag{
		...
		Value: neut.DefaultConfig.Tendermint.TimeoutPrecommitDelta,
	}
	TendermintTimeoutCommitFlag = cli.DurationFlag{
		...
		Value: neut.DefaultConfig.Tendermint.TimeoutCommit,
	}
...
func SetULC(ctx *cli.Context, cfg *neut.Config) {
	...
	if cfg.ULC.MinTrustedFraction <= 0 && cfg.ULC.MinTrustedFraction > 100 {
		log.Error("MinTrustedFraction is invalid", "MinTrustedFraction", cfg.ULC.MinTrustedFraction, "Changed to default", neut.DefaultULCMinTrustedFraction)
		cfg.ULC.MinTrustedFraction = neut.DefaultULCMinTrustedFraction
	}
}

// makeDatabaseHandles raises out the number of allowed file handles per process
// for Gev and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `gnc account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func setEtherbase(ctx *cli.Context, ks *keystore.KeyStore, cfg *neut.Config) {
...
func SetP2PConfig(ctx *cli.Context, cfg *p2p.Config) {
	...
	log.Info("Maximum peer count", "GEV", ethPeers, "LES", lightPeers, "total", cfg.MaxPeers)
...
func setEthash(ctx *cli.Context, cfg *neut.Config) {
...
func setWhitelist(ctx *cli.Context, cfg *neut.Config) {
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "gnc.", tagsMap)
		}
	}
}
...
func MakeChainDatabase(ctx *cli.Context, stack *node.Node) neutdb.Database {
	var (
...
func MakeChain(ctx *cli.Context, stack *node.Node) (chain *core.BlockChain, chainDb neutdb.Database) {
	var err error
	...
	if config.Clique != nil {
		...
		if !ctx.GlobalBool(FakePoWFlag.Name) {
			engine = ethash.New(ethash.Config{
				CacheDir:       stack.ResolvePath(neut.DefaultConfig.Ethash.CacheDir),
				CachesInMem:    neut.DefaultConfig.Ethash.CachesInMem,
				CachesOnDisk:   neut.DefaultConfig.Ethash.CachesOnDisk,
				DatasetDir:     stack.ResolvePath(neut.DefaultConfig.Ethash.DatasetDir),
				DatasetsInMem:  neut.DefaultConfig.Ethash.DatasetsInMem,
				DatasetsOnDisk: neut.DefaultConfig.Ethash.DatasetsOnDisk,
			}, nil, false)
		}
	}
	if gcmode := ctx.GlobalString(GCModeFlag.Name); gcmode != "full" && gcmode != "archive" {
	...
	cache := &core.CacheConfig{
		TrieCleanLimit:      neut.DefaultConfig.TrieCleanCache,
		TrieCleanNoPrefetch: ctx.GlobalBool(CacheNoPrefetchFlag.Name),
		TrieDirtyLimit:      neut.DefaultConfig.TrieDirtyCache,
		TrieDirtyDisabled:   ctx.GlobalString(GCModeFlag.Name) == "archive",
		TrieTimeLimit:       neut.DefaultConfig.TrieTimeout,
	}
	if ctx.GlobalIsSet(CacheFlag.Name) || ctx.GlobalIsSet(CacheTrieFlag.Name) {
...
// new format.
//
// e.g. gnc account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// gnc --keystore /tmp/mykeystore --lightkdf account new
//
