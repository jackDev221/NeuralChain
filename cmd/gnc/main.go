...
const (
	clientIdentifier = "gnc" // Client identifier to advertise over the network
)
...
func init() {
	// Initialize the CLI app and start Gev
	app.Action = gnc
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2019 The NeuralChain Authors "
...
// gev is the main entry point into the system if no special subcommand is ran.
// It creates a default node based on the command line arguments and runs it in
// blocking mode, waiting for it to be shut down.
func gnc(ctx *cli.Context) error {
