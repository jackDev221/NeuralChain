...
var (
	walletCommand = cli.Command{
		...
		Description: `
    gnc wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	gnc wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    gnc account update [options] <address>
...
func accountCreate(ctx *cli.Context) error {
	cfg := gevConfig{Node: defaultNodeConfig()}
	// Load config file.
