...
const (
	ipcAPIs  = "admin:1.0 debug:1.0 ethash:1.0 neut:1.0 miner:1.0 net:1.0 personal:1.0 rpc:1.0 shh:1.0 txpool:1.0 web3:1.0"
	httpAPIs = "neut:1.0 net:1.0 rpc:1.0 web3:1.0"
)
...
func testAttachWelcome(t *testing.T, gev *testgev, endpoint, apis string) {
	// Attach to a running gnc note and terminate immediately
