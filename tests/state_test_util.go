...
func MakePreState(db neutdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/NeuralChainLabs/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
