...
// Package evrynetNode defines interfaces for interacting with Evrynet.
package evrynet
...
type FilterQuery struct {
	BlockHash *common.Hash     // used by neut_getLogs, return logs only from block with this hash
