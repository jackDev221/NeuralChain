...
import "github.com/lvbin2012/NeuralChain/accounts/abi"
...
{{range $contract := .Contracts}}
	...
	{{if .InputBin}}
		...
		// Deploy{{.Type}} deploys a new NeuralChain contract, binding an instance of {{.Type}} to it.
	...
	// {{.Type}} is an auto generated Go binding around an NeuralChain contract.
	type {{.Type}} struct {
	...
	// {{.Type}}Caller is an auto generated read-only Go binding around an NeuralChain contract.
	type {{.Type}}Caller struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Transactor is an auto generated write-only Go binding around an NeuralChain contract.
	type {{.Type}}Transactor struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Filterer is an auto generated log filtering Go binding around an NeuralChain contract events.
	type {{.Type}}Filterer struct {
	  contract *bind.BoundContract // Generic contract wrapper for the low level calls
	}

	// {{.Type}}Session is an auto generated Go binding around an NeuralChain contract,
	...
	// {{.Type}}CallerSession is an auto generated read-only Go binding around an NeuralChain contract,
	...
	// {{.Type}}TransactorSession is an auto generated write-only Go binding around an NeuralChain contract,
	...
	// {{.Type}}Raw is an auto generated low-level Go binding around an NeuralChain contract.
	type {{.Type}}Raw struct {
	  Contract *{{.Type}} // Generic contract binding to access the raw methods on
	}

	// {{.Type}}CallerRaw is an auto generated low-level read-only Go binding around an NeuralChain contract.
	type {{.Type}}CallerRaw struct {
		Contract *{{.Type}}Caller // Generic read-only contract binding to access the raw methods on
	}

	// {{.Type}}TransactorRaw is an auto generated low-level write-only Go binding around an NeuralChain contract.
...
{{range $contract := .Contracts}}
	public class {{.Type}} {
		...
		{{if .InputBin}}
			...
			// deploy deploys a new NeuralChain contract, binding an instance of {{.Type}} to it.
			public static {{.Type}} deploy(TransactOpts auth, NeuralChainClient client{{range .Constructor.Inputs}}, {{bindtype .Type}} {{.Name}}{{end}}) throws Exception {
		...
		// NeuralChain address where this contract is located at.
		public final Address Address;

		// NeuralChain transaction in which this contract was deployed (if known!).
		...
		public {{.Type}}(Address address, NeuralChainClient client) throws Exception {
