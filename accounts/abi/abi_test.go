...
func ExampleJSON() {
	...
	addr, _ := common.NeutAddressStringToAddressCheck("NKuyBkoGdZZSLyPbJEetheRhMjezqzTxcW")
...
func TestUnpackEventIntoMap(t *testing.T) {
	...
	sender, _ := common.NeutAddressStringToAddressCheck("NQy24i5Hs2gwFqhquM1nmoorRgaQxjBvu8")
