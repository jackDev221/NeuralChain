...
func TestTransactionValidation(t *testing.T) {
	...
	testcases := []txtestcase{
		// valid NKuyBkoGdZZSLyPbJEetheRhMmZt6MKMwX
		{from: "NKuyBkoGdZZSLyPbJEetheRhMmZt6MKMwX", to: "NKuyBkoGdZZSLyPbJEetheRhMmZt6MKMwX",
		...
		// Send to 0
		{from: "NKuyBkoGdZZSLyPbJEetheRhMmZt6MKMwX", to: "NKuyBkoGdZZSLyPbJEetheRhMjeznFZszf",
			n: "0x01", g: "0x20", gp: "0x40", value: "0x01", numMessages: 1},
		// Create empty contract (no value)
		{from: "NKuyBkoGdZZSLyPbJEetheRhMmZt6MKMwX", to: "",
