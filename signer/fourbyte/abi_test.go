...
func TestNewUnpacker(t *testing.T) {
	...
	addr, _ := common.NeutAddressStringToAddressCheck("NKuyC5hkQw1MmkCqjY7xLopKZkoAhrypGZ")
	testcases := []unpackTest{
		...
		}, { // https://github.com/NeuralChainLabs/wiki/wiki/NeuralChain-Contract-ABI#examples
...
[
	...
	for i, hexdata := range []string{
		...
		// From https://github.com/NeuralChainLabs/wiki/wiki/NeuralChain-Contract-ABI
