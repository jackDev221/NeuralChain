...
func TestNewUnpacker(t *testing.T) {
	...
	addr, _ := common.EvryAddressStringToAddressCheck("EH9uVujzDKjqR5R7F9TaeJNayfeJQrEwmp")
	testcases := []unpackTest{
		...
		}, { // https://github.com/Evrynetlabs/wiki/wiki/Evrynet-Contract-ABI#examples
...
[
	...
	for i, hexdata := range []string{
		...
		// From https://github.com/Evrynetlabs/wiki/wiki/Evrynet-Contract-ABI
