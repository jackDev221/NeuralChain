...
// NodeConfig represents the collection of configuration values to fine tune the gnc
// node embedded into a mobile process. The available values are a subset of the
// entire API provided by NeuralChaine to reduce the maintenance surface and dev
// complexity.
...
// Node represents a gnc NeuralChain node instance.
type Node struct {
	node *node.Node
}
