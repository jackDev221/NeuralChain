...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db neutdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db neutdb.Database) error {
