...
// mapped from textual names used in the tests below to actual NeuralChain private
...
// address retrieves the NeuralChain address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the NeuralChain address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/lvbin2012/NeuralChain/issues/17593). Whilst this
	...
	for i, tt := range tests {
		...
		for j, block := range blocks {
			// Gev the header and prepare it for signing
			header := block.Header()
			if j > 0 {
