...
var (
	tendermintRoundMeter        = metrics.NewRegisteredMeter("neut/consensus/tendermint/rounds", nil)
	tendermintProposalWaitTimer = metrics.NewRegisteredTimer("neut/consensus/tendermint/proposalwait", nil)
)
