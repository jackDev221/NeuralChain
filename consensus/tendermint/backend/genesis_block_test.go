...
var (
	...
	stakingScAddress, _    = common.EvryAddressStringToAddressCheck("EMHju71XkmyxKJgaqf1QnzxdwGu627GEnN")
...
// createBlockchainAndBackendFromGenesis returns backend, blockchain and neut.Database for testing
func createBlockchainAndBackendFromGenesis(genesisPath string) (*Backend, *core.BlockChain, neutdb.Database, error) {
