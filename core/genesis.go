...
func SetupGenesisBlock(db neutdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	return SetupGenesisBlockWithOverride(db, genesis)
}
func SetupGenesisBlockWithOverride(db neutdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) ToBlock(db neutdb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db neutdb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db neutdb.Database) *types.Block {
...
func GenesisBlockForTesting(db neutdb.Database, addr common.Address, balance *big.Int) *types.Block {
...
// DeveloperGenesisBlock returns the 'gnc --dev' genesis block. Note, this must
// be seeded with the
