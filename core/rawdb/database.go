...
func NewDatabase(db neutdb.KeyValueStore) neutdb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db neutdb.KeyValueStore, freezer string, namespace string) (neutdb.Database, error) {
...
func NewMemoryDatabase() neutdb.Database {
...
func NewMemoryDatabaseWithCap(size int) neutdb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (neutdb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (neutdb.Database, error) {
...
func InspectDatabase(db neutdb.Database) error {
	it := db.NewIterator()
	defer it.Release()
