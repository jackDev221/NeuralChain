...
func NewTable(db neutdb.Database, prefix string) neutdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator() neutdb.Iterator {
...
// not exist).
func (t *table) NewIteratorWithStart(start []byte) neutdb.Iterator {
	return t.db.NewIteratorWithStart(start)
}

// NewIteratorWithPrefix creates a binary-alphabetical iterator over a subset
// of database content with a particular key prefix.
func (t *table) NewIteratorWithPrefix(prefix []byte) neutdb.Iterator {
...
func (t *table) NewBatch() neutdb.Batch {
...
func (b *tableBatch) Replay(w neutdb.KeyValueWriter) error {
