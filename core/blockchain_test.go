...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (neutdb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (neutdb.Database, func()) {
...
//
// https://github.com/lvbin2012/NeuralChain/pull/15941
...
//
// Details at:
//  - https://github.com/lvbin2012/NeuralChain/issues/18977
//  - https://github.com/lvbin2012/NeuralChain/pull/18988
