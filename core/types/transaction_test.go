...
// at github.com/NeuralChainLabs/tests.
var (
	a, _    = common.NeutAddressStringToAddressCheck("NLmWTHXA4cJdMJer5LskzXmvrW3Jra3uiB")
	b, _    = common.NeutAddressStringToAddressCheck("Ea3jXjtJ3BqZneXsUKFhENkHDVT9y3TT1t")
...
func TestTransaction_AsMessage(t *testing.T) {
	var (
		...
		contractAddr, _ = common.NeutAddressStringToAddressCheck("NKuyBkoGdZZSLyPbJEetheRhMjezwhg9vh")
