...
var (
	a, _    = common.NeutAddressStringToAddressCheck("EJ1Sm7ZPs136zds7axDPJ2LCGQtSi8B2AN")
...
func TestTransaction_AsMessage(t *testing.T) {
	var (
		...
		contractAddr, _ = common.NeutAddressStringToAddressCheck("EH9uVaqWRxHuzJbroqzX18yxmeW8hGraaK")
