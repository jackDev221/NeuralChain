...
// account array.
func checkStateAccounts(t *testing.T, db neutdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db neutdb.Database, root common.Hash) error {
...
func checkStateConsistency(db neutdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(neutdb.Database), srcRoot)
