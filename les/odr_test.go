...
type odrTestFn func(ctx context.Context, db neutdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte

func TestOdrGetBlockLes2(t *testing.T) { testOdr(t, 2, 1, true, odrGetBlock) }

func odrGetBlock(ctx context.Context, db neutdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
...
func odrGetReceipts(ctx context.Context, db neutdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
...
func odrAccounts(ctx context.Context, db neutdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
	dummyAddr, _ := common.NeutAddressStringToAddressCheck("EJpAMXeGR3CEaEP2e53tn28cUDZTZxFW3z")
...
func odrContractCall(ctx context.Context, db neutdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
...
func odrTxStatus(ctx context.Context, db neutdb.Database, config *params.ChainConfig, bc *core.BlockChain, lc *light.LightChain, bhash common.Hash) []byte {
