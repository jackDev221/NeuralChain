...
// package web3ext contains gnc specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			...
			call: 'neut_providerSignTransaction',
			params: 2,
    		inputFormatter: [null, web3._extend.formatters.inputAddressFormatter]
		}),
		new web3._extend.Method({
			name: 'getBlockSignerByHash',
			call: 'neut_getBlockSignerByHash',
			params: 1,
    		inputFormatter: [web3._extend.utils.toHex]
		}),
		new web3._extend.Method({
			name: 'getBlockSignerByNumber',
			call: 'neut_getBlockSignerByNumber',
			params: 1,
    		inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter]
		}),
		new web3._extend.Method({
			name: 'submitTransaction',
			call: 'neut_submitTransaction',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputTransactionFormatter]
		}),
		new web3._extend.Method({
			name: 'getRawTransaction',
			call: 'neut_getRawTransactionByHash',
			params: 1
		}),
		new web3._extend.Method({
			name: 'getRawTransactionFromBlock',
			call: function(args) {
				return (web3._extend.utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'neut_getRawTransactionByBlockHashAndIndex' : 'neut_getRawTransactionByBlockNumberAndIndex';
			},
			params: 2,
	...
	properties: [
		new web3._extend.Property({
			...
			getter: 'neut_pendingTransactions',
