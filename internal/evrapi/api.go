...
//
// https://github.com/lvbin2012/NeuralChain/wiki/Management-APIs#personal_sign
...
// Note, this function is compatible with evr_sign and personal_sign. As such it recovers
// the address of:
...
// Unpair deletes a pairing between wallet and gnc.
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#evr_sign
...
func (s *PublicTransactionPoolAPI) Resend(ctx context.Context, sendArgs SendTxArgs, gasPrice *hexutil.Big, gasLimit *hexutil.Uint64) (common.Hash, error) {
	...
	for _, p := range pending {
		var signer types.Signer = types.BaseSigner{}
		if p.Protected() {
			signer = types.NewOmahaSigner(p.ChainId())
		}
