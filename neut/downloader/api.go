...
// Syncing provides information when this nodes starts synchronising with the NeuralChain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  neuralChain.SyncProgress `json:"status"`
}
