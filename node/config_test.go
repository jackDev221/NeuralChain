...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gnc.ipc", false, filepath.Join(os.TempDir(), "gnc.ipc")},
		{"data", "gnc.ipc", false, "data/gnc.ipc"},
		{"data", "./gnc.ipc", false, "./gnc.ipc"},
		{"data", "/gnc.ipc", false, "/gnc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gnc.ipc", true, `\\.\pipe\gnc.ipc`},
		{"data", "gnc.ipc", true, `\\.\pipe\gnc.ipc`},
		{"data", `\\.\pipe\gnc.ipc`, true, `\\.\pipe\gnc.ipc`},
	}
