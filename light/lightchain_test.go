...
func makeHeaderChain(parent *types.Header, n int, db neutdb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (neutdb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() neutdb.Database {
	return odr.db
}
