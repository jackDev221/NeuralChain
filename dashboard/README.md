...
As the dashboard depends on certain NPM packages (which are not included in the `NeuralChain` repo), these need to be installed first:
...
```
$ gev --dashboard --vmodule=dashboard=5
