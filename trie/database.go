...
type Database struct {
	diskdb neutdb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb neutdb.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb neutdb.KeyValueStore, cache int) *Database {
...
func (db *Database) DiskDB() neutdb.KeyValueReader {
	return db.diskdb
}
...
func (db *Database) Cap(limit common.StorageSize) error {
	...
	if flushPreimages {
		for hash, preimage := range db.preimages {
			...
			if batch.ValueSize() > neutdb.IdealBatchSize {
...
func (db *Database) commit(hash common.Hash, batch neutdb.Batch, uncacher *cleaner) error {
